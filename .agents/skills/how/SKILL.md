...
- `model`: your configured how-explorer model (default `sonnet/high`)
- `readonly`: `true`
...
- `subagent_type`: `generalPurpose`
- `model`: your configured how-explainer model (default `opus/xhigh`)
- `readonly`: `true`
...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list (defaults `opus/xhigh`, `opus/high`, `sonnet/high`, `opus/medium`), all in a single message.
